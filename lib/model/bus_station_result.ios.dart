...
import 'package:amap_search/model/city.ios.dart';
...
class Suggestion {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is Suggestion && runtimeType == other.runtimeType && cities == other.cities && keywords == other.keywords;
...
class Busstops {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (buslines != null) {
      data['buslines'] = buslines!.map((v) => v.toJson()).toList();
    }
    data['name'] = name;
    return data;
  }
