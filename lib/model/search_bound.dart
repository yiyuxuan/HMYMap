...
class SearchBound {
  ...
  SearchBound.fromJson(Map<String, dynamic> json)
      : lowerLeft = json['lowerLeft'] != null ? LatLng.fromJson(json['lowerLeft'] as Map<String, Object>) : null,
        upperRight = json['upperRight'] != null ? LatLng.fromJson(json['upperRight'] as Map<String, Object>) : null,
        center = json['center'] != null ? LatLng.fromJson(json['center'] as Map<String, Object>) : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    data['lowerLeft'] = lowerLeft?.toJson();
    data['upperRight'] = upperRight?.toJson();
    data['center'] = center?.toJson();
    data['range'] = range;
    data['shape'] = shape;
    data['isDistanceSort'] = isDistanceSort;
    data['polyGonList'] = polyGonList?.map((it) => it.toJson()).toList() ?? [];
    return data;
  }
