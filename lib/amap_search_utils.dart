...
import 'package:amap_search_utils/model/amap_geocode.dart';
import 'package:amap_search_utils/model/amap_poi_model.dart';
import 'package:flutter/services.dart';
export 'package:amap_search_utils/model/amap_geocode.dart';
export 'package:amap_search_utils/model/amap_poi_model.dart';

class AmapSearchUtils {
  static const MethodChannel _channel = MethodChannel('amap_search_utils');
