#import "AmapSearchUtilsPlugin.h"
#import <AMapSearchKit/AMapSearchKit.h>
#import <objc/message.h>


@interface AmapSearchUtilsPlugin ()<AMapSearchDelegate>
{
...
@implementation AmapSearchUtilsPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
            methodChannelWithName:@"amap_search_utils"
                  binaryMessenger:[registrar messenger]];
    AmapSearchUtilsPlugin* instance = [[AmapSearchUtilsPlugin alloc] init];
