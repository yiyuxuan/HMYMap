package com.github.hugochou.amap_search.search
...
import com.github.hugochou.amap_search.*
import com.github.hugochou.amap_search.common.*
 ...
 * 设置api key
 */
object SetApiKey : SearchMethodHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        result.error("missing argument", "missing android key", "")
    }
}
 ...
 * 设置隐私权限
 */
object UpdatePrivacyStatement : SearchMethodHandler {

    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        val privacyShowMap = call.arguments as? Map<*, *>;
        if (null != privacyShowMap) {
            if (privacyShowMap.containsKey("hasContains") && privacyShowMap.containsKey("hasShow")) {
                ServiceSettings.updatePrivacyShow(
                    AmapSearchPlugin.context, privacyShowMap.get("hasContains") as Boolean,
                    privacyShowMap.get("hasShow") as Boolean
                )
                result.success(null)
                return
            }
            if (privacyShowMap.containsKey("hasAgree")) {
                ServiceSettings.updatePrivacyAgree(
                    AmapSearchPlugin.context,
                    privacyShowMap.get("hasAgree") as Boolean
                )
                result.success(null)
                return
            }
...
object SearchReGeocode : SearchMethodHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        GeocodeSearch(AmapSearchPlugin.activity).run {
...
object SearchPoiBound : SearchMethodHandler {
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        query.parseFieldJson<UnifiedPoiSearchQuery>()
            .toPoiSearchBound(AmapSearchPlugin.context)
            .apply {
...
object SearchPoiId : SearchMethodHandler {
    ...
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        PoiSearch(AmapSearchPlugin.context, null).apply {
            setOnPoiSearchListener(object : PoiSearch.OnPoiSearchListener {
                override fun onPoiItemSearched(result: PoiItem?, rCode: Int) {
                    if (rCode == AMapException.CODE_AMAP_SUCCESS) {
                        if (result != null) {
...
object SearchPoiKeyword : SearchMethodHandler {
    ...
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        query.parseFieldJson<UnifiedPoiSearchQuery>()
            .toPoiSearch(AmapSearchPlugin.context)
            .apply {
                setOnPoiSearchListener(object : PoiSearch.OnPoiSearchListener {
                    override fun onPoiItemSearched(result: PoiItem?, rCode: Int) {}
...
object SearchPoiPolygon : SearchMethodHandler {
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        query.parseFieldJson<UnifiedPoiSearchQuery>()
            .toPoiSearchPolygon(AmapSearchPlugin.context)
            .apply {
                setOnPoiSearchListener(object : PoiSearch.OnPoiSearchListener {
                    override fun onPoiItemSearched(result: PoiItem?, rCode: Int) {}
...
object SearchRoutePoiLine : SearchMethodHandler {
    ...
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        query.parseFieldJson<UnifiedRoutePoiSearchQuery>()
            .toRoutePoiSearchLine(AmapSearchPlugin.context)
            .apply {
...
object SearchRoutePoiPolygon : SearchMethodHandler {
    ...
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        query.parseFieldJson<UnifiedRoutePoiSearchQuery>()
            .toRoutePoiSearchPolygon(AmapSearchPlugin.context)
            .apply {
                setPoiSearchListener { result, rCode ->
                    if (rCode == AMapException.CODE_AMAP_SUCCESS) {
                        if (result != null) {
...
object CalculateDriveRoute : SearchMethodHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        RouteSearch(AmapSearchPlugin.context).run {
...
object DistanceSearchHandler : SearchMethodHandler {
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        val search = DistanceSearch(AmapSearchPlugin.context)
...
object SearchBusStation : SearchMethodHandler {
    ...
    override fun onMethodCall(methodCall: MethodCall, methodResult: MethodChannel.Result) {
        ...
        BusStationSearch(AmapSearchPlugin.context, BusStationQuery(stationName, city))
            .run {
